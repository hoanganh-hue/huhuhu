...
# -*- coding: utf-8 -*-
"""
Script để tạo 1000 CCCD cho tỉnh Hà Nội, giới tính nữ, năm sinh từ 1965 đến 1975
...
from modules.cccd.cccd_generator_service import CCCDGeneratorService
from modules.cccd.checksum import is_checksum_valid

def main():
    """Hàm chính để tạo CCCD"""
    print("🚀 Bắt đầu tạo 1000 CCCD cho tỉnh Hà Nội, giới tính nữ (1965-1975)")
    print("=" * 70)
    ...
    try:
        ...
        output_file = "hanoi_female_1965_1975.json"
        output_data = {
            "metadata": {
                "description": "1000 CCCD tỉnh Hà Nội, giới tính nữ, năm sinh 1965-1975",
                "province": "Hà Nội (001)",
                "gender": "Nữ",
